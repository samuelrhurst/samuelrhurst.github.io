...
This uses the GitHub Actions workflow that was included with the Hextra starter template ([`.github/workflows/pages.yaml`](./.github/workflows/pages.yaml)) to publishing the blog to [GitHub Pages](https://github.blog/changelog/2022-07-27-github-pages-custom-github-actions-workflows-beta/). 
